...
public class MatchSelector extends JPanel {
	
	private MatchSelector partner;
	...
	private String[] columnNames = {"Opponent",
        "Date",
        "Result",
        "Points Won %"};
	...
	public MatchSelector getPartner() {
		return partner;
	}


	public void setPartner(MatchSelector partner) {
